...
% --- Title ---
\title{\Large \textbf{Minority Report: Contrarian Traders, Prediction Markets,\\and the Return of Post-Earnings Drift}\thanks{Advised by Kevin Smith, PhD, Stanford Graduate School of Business. Data provided with assistance by Kurush Dubash and Kunal Roy, founders of Dome API (acquired by Polymarket).}}

\author{Chloe Feng\thanks{Stanford University Graduate School of Business. Email: chloefn@stanford.edu}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figures/fig_eps_waterfall.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figures/fig_return_drift.pdf}
...
\noindent\textbf{Disclosure.} The author invested in Dome API (acquired by Polymarket) through the a16z scout program.
